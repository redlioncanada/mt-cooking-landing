                            ...
                            videos: [
                                {
                                    ...
                                    thumb: './public/images/video-select-1.jpg',
                                    title: 'Fours Maytag<sup>&reg;</sup> – mettez-vous aux fourneaux!',
                                    alt: "test",
                                    ctaTitle: 'FOURS DOUBLES<sup>&reg;</sup>',
                                    ctaText: 'Voir',
                                    ctaBackground: "./public/images/button-background.png",
                        ...
                        productselector: {
                            ...
                            products: [
                                ...
                                },
                                {
                                    ...
                                    desc: "Les tables de cuisson offrent une surface épurée pour tous vos besoins : ébullition, mijotage et friture. Que la table de cuisson se trouve sur une cuisinière ou sur une table de cuisson encastrée, la technologie est la même. La table de cuisson est conçue pour conserver l'élégance de votre cuisine tout en offrant des résultats précis.",
